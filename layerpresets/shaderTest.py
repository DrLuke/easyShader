...
class Layer(BaseLayer):
    ...
    def render(self, runtimeData):
        ...
        self.timeAcc += runtimeData.dt * self.checkUniform(runtimeData, "test", "test", 0) * 0.1
        self.u1("test", self.timeAcc)

        self.u1("green", self.checkUniform(runtimeData, "test", "greenness", 0))
